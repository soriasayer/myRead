...
└── src
    ...
    ├── BookShelfs.js # This component contain all codes for the main page along with three shelves.
    ├── BookSearch.js # This component contain the input along with the books item.
        ├── BookList.js # This component renders the book item.
